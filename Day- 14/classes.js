...
class Person {
  ...
  const person = new Person("Deadpool", 30);
  console.log(person);
  person.greeting();
  ...
  const student = new Student("Wolverine", 10);
  console.log(student);
  ...
  const newPerson = new Person2("Abhinav", 24, "Kumar");
  
  console.log(newPerson.fullName);
  
  // Task-8: Add a setter method to the "Person" class to update the name properties ("firstname" and "lastname"). Update the name using the setter and log the updated full name.
  
  const anotherPerson = new Person2("John", "Cena");
  console.log(anotherPerson.fullName);
  
  anotherPerson.fullName = "Mary Jane";
  console.log(anotherPerson.fullName);
  ...
  myAccount.getPublicDeposit(4000);
  console.log(myAccount.getBalance());
